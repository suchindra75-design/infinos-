...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    <ModalShell isOpen={isOpen} onClose={onClose} maxWidthClass="max-w-lg" ariaLabel="Compartment Thresholds">
      ...
      {/* Modal Body */}
      <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4 overflow-y-auto font-body flex-1 min-h-0">
        {formError && (
        ...
        <div className="pt-2 border-t border-white/[0.08] flex items-center justify-between gap-3">
          ...
          <label className="relative inline-flex items-center cursor-pointer shrink-0">
            ...
            />
            <div className="w-11 h-6 bg-zinc-800 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-zinc-300 after:border after:rounded-full after:h-5 after:w-5 peer-active:after:scale-90 after:transition-[transform,background-color,border-color] after:duration-[var(--dur-fast)] after:ease-[var(--ease-out)] peer-checked:bg-[#ff6b00]"></div>
          </label>
        </div>
